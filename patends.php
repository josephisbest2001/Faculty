                ...
                <div class="list-group">
                    <div class="list-group-item patent-item">
                        ...
                        <div class="flex-grow-1">
                            <strong class="custom-color">Design of a web application monitoring
                            solution in the Azure environment</strong>
                            <br>
